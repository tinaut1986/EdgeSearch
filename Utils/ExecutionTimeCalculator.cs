...
namespace EdgeSearch.Utils
{
    public class ExecutionTimeCalculator
    {
        public static TimeSpan CalculateTotalTime(int totalExecutions, int executionsOffset, int executionsPerStrike,
            int pauseBetweenExecutions, int pauseBetweenStrikes, int elapsedSeconds, int currentPause, bool playing)
        {
            ...
            int totalTimeInSeconds = (remainingExecutions * pauseBetweenExecutions) + (totalStrikes * pauseBetweenStrikes);
